...
const chains: Chain[] = [
  ...
  },
  {
    ...
    date: "2026년 4월 23일",
    label: "4월 22일 거시경제",
    description: "이자·유가·비트코인 동반 상승, 전쟁 불안 속 위험자산 재가동 — 안도 랠리",
    cardCount: 6,
    isPositive: true,
  },
  {
    ...
    date: "2026년 4월 23일",
    label: "4월 22일 시황",
    description: "실적 좋은 에너지·AI 인프라·의료기기만 강세, 소비·리츠는 유가·금리에 눌려",
    cardCount: 6,
    isPositive: true,
  },
  {
  ...
  },
  {
    ...
    date: "2026년 4월 22일",
    label: "4월 21일 시황",
    description: "이란 긴장 속 에너지만 ▲1.62%, 방산·코인·리츠 동반 급락 — 스토리보다 숫자",
    cardCount: 6,
    isPositive: false,
  },
  {
    ...
    date: "2026년 4월 21일",
    label: "4월 20일 거시경제",
    description: "호르무즈발 유가 ▲4.6% 급등, 주식 숨고르기, 비트코인·이더리움 ▲3%대 홀로 강세",
    cardCount: 6,
    isPositive: true,
  },
  {
